...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title>WebAdmin - Help Center</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Keluhan yang masuk ke sistem</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <?php
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($help as $help) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="mailto:<?php echo $help->email; ?>?Subject=Jawaban%20komplain%20edcshops.com" target="_top"><?php echo $help->email; ?></td>
