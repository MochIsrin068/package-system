<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Midtrans_payment {
        ...
        //var $server_key = "SB-Mid-server-rv9DkQjTQrH5P4jBvErYhtep";
        var $server_key = "Mid-server-Xd4iu-C64eNHXxNcdRi_KvHq";
        ...
        function __construct() {
            ...
            $this->basepath = $this->is_production ? 'https://app.midtrans.com/' : 'https://app.sandbox.midtrans.com/';
            $this->server_key = $this->is_production ? 'Mid-server-Xd4iu-C64eNHXxNcdRi_KvHq' : 'SB-Mid-server-rv9DkQjTQrH5P4jBvErYhtep';
        }
